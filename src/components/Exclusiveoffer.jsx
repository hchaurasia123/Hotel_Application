...
const Exclusiveoffer = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24xl:px-32 pt-20 pb-30'>
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
          ...
          {exclusiveOffers.map((item)=>(
            ...
            <p className='px-3 py-1 absolute top-4 left-4 text-x5 bh-white text-gray-800 font-medium rounded-full'>{item.priceOff}% OFF</p>
       <div>
