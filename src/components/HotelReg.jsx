...
const HotelReg = () => {
  ...
  {/* Hotel Name */}
            ...
            {/* Contact */}
             ...
             <div className='w-full mt-4'>
            <label htmlFor="name" className='font-medium text-gray-500'>Contact</label>
          ...
          {/* Address */}
             ...
             <div className='w-full mt-4'>
            <label htmlFor="name" className='font-medium text-gray-500'>Address</label>
            ...
            <div className='w-full mt-4 max-w-60 mr-auto'>
                ...
                <select  id="city" className='border border-gray-500 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required>
                    <option value="">
                        Select City
                    </option>
                    {cities.map((city)=>(
