...
const Hotelcard = ({room,index}) => {
  return (
    ...
    className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_rgba(0,0,0,0,0.05)]'>
        ...
        <div className='p-4 pt-5'>
            ...
            <div className='flex items-center justify-between mt-4'>
                ...
                <button className='px-2 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-50 transition-all cursor-pointer'>Book Now</button>
            </div>
        </div>
    </Link>
  )
