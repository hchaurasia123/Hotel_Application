...
const Mybooking = () => {
  ...
  return (
    ...
    {/* Booking  */}
        <Title   title='My Bookings' subTitle='Easily  manage your past,current, and upcoming hotel reservation in one place.Plan your tips seamlessly with just a few clicks' align='left'/>
              ...
              bookings.map((booking,index)=>(
                ...
                <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                  ...
                  <div className='flex flex-col md:flex-row gap-4'>
                    <img src={booking.room.images[0]} alt="hotelimg" className='min-md:w-44 rounded shadow object-cover' />
                  ...
                  <div className='flex flex-col md:items-center justify-center pt-3'>
